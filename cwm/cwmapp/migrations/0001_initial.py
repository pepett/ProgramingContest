# Generated by Django 4.2 on 2023-08-07 04:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_good_user_mail', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rep_mail', models.EmailField(max_length=254)),
        ...
        migrations.AddConstraint(
            model_name='repgood',
            constraint=models.UniqueConstraint(fields=('rep_mail', 'rep_id'), name='unique_rep_good'),
        ),
        migrations.AddConstraint(
            model_name='good',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('comment_good_user_mail', 'comment_good_music_id'), name='unique_comment_good'),
        ),
        migrations.AddField(
