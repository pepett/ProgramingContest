# Generated by Django 4.2 on 2023-08-01 06:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userid', models.CharField(default=uuid.UUID('870699d1-bd98-4eb0-875e-314a39a3693e'), error_messages={'msg': 'fuck!'}, help_text='この名前は公開されません。', max_length=100, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='userid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_userid', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_userid', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('history_userid', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('like_userid', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply_userid', models.EmailField(max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('star_userid', models.EmailField(max_length=254)),
