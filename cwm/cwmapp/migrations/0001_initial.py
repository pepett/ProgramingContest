# Generated by Django 4.2 on 2023-07-27 02:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userid', models.CharField(default=uuid.UUID('c6408cd2-0316-4884-8549-b5abc4d3444d'), error_messages={'msg': 'fuck!'}, help_text='この名前は公開されません。', max_length=100, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='userid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music_track_full', models.FileField(upload_to='albums/tracks/full/')),
                ('music_track_preview', models.FileField(upload_to='albums/tracks/preview')),
            ],
        ),
        migrations.CreateModel(
            name='Reply',
