...
HisLabel = document.getElementById("HisLabel");
SetLabel = document.getElementById("SetLabel");
UplLabel = document.getElementById("UplLabel");
...
UserRadioBox[3].addEventListener('click', () =>{
  checkbox();
});
...
function checkbox(){
    if(UserRadioBox[0].checked){
        ...
        UplLabel.style.color = textColor2;
    }
    ...
    if(UserRadioBox[3].checked){
      ...
      HisLabel.style.color = textColor2;
      SetLabel.style.color = textColor2;
      UplLabel.style.color = textColor;
  }
};
